...
# params defined for MIC
_C.MODEL.MIC_ON = False
_C.MODEL.MASKING_BLOCK_SIZE = 32
_C.MODEL.MASKING_RATIO = 0.5
_C.MODEL.TEACHER_ALPHA = 0.9
_C.MODEL.PSEUDO_LABEL_THRESHOLD = 0.7
_C.MODEL.PSEUDO_LABEL_LAMBDA = 0.5
_C.MODEL.MASKING_AUGMENTATION = False
_C.MODEL.PSEUDO_LABEL_WEIGHT = 'none'
